...
export const getCurrentBoardTile = (state: { app: AppState }, tileId: number) =>
  createSelector([app], (app): Array<BoardTile> => {
    console.log(`selector`, tileId, state, app);
    return app.currentBoardTiles;
  })(state);
